      ...
      <nav id="sidebar" class="lg:min-w-[250px] w-max max-lg:min-w-8">
        <div id="sidebar-collapse-menu"
          ...
          <div class="pt-8 pb-2 px-6 sticky top-0 bg-white min-h-[80px] z-[100]">
            <a href="javascript:void(0)" class="outline-none"><img src="https://readymadeui.com/readymadeui.svg"
          ...
          <div class="py-6 px-6">
            ...
            <div class="mt-8">
              <div class="bg-[#00b074] p-4 rounded-md shadow-md max-w-[196px]">
                ...
                <button type="button"
                  class="py-2 px-4 bg-white hover:bg-gray-100 text-gray-800 text-sm border-none outline-none rounded-md mt-4">Add
                  Menu</button>
              </div>
            </div>
          </div>
