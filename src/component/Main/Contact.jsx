...
<section className="mb-32">
    ...
    <div className="flex flex-wrap">
        ...
        <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
            ...
            <div className="mb-3 w-full">
                ...
                <input type="text" className="px-2 py-2 border w-full outline-none rounded-md" id="exampleInput90" placeholder="Ad" />
            </div>
  ...
  <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
    <div className="flex items-start">
      <div className="shrink-0">
        <div className="inline-block rounded-md bg-yellow-200 p-4 text-yellow-800">
      ...
      <div className="ml-6 grow">
        <p className="mb-2 font-bold text-brown-800">Texniki problem</p>
        <p className="text-neutral-600">support@example.com</p>
        <p className="text-neutral-600">+1 234-567-89</p>
      </div>
    </div>
  </div>
  ...
  <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
    <div className="flex items-start">
      <div className="shrink-0">
        <div className="inline-block rounded-md bg-green-200 p-4 text-green-800">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16 11V7a4 4 0 10-8 0v4m-2 0a2 2 0 012-2h8a2 2 0 012 2v8a2 2 0 01-2 2H6a2 2 0 01-2-2v-8a2 2 0 012-2zm4-4v4" />
      ...
      <div className="ml-6 grow">
        <p className="mb-2 font-bold text-brown-800">Məhsullar Haqqında Sorğular</p>
        <p className="text-neutral-600">sales@example.com</p>
        <p className="text-neutral-600">+1 234-567-89</p>
      </div>
    </div>
  </div>
  ...
  <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
    <div className="flex items-start">
      <div className="shrink-0">
        <div className="inline-block rounded-md bg-blue-200 p-4 text-blue-800">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="h-6 w-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 10l4.553-2.276A2 2 0 0122 9.553v4.894a2 2 0 01-2.447 1.829L15 14M4 6h16M4 10h16m-7 8H4m6-4H4m14-5v10a2 2 0 01-2 2H6a2 2 0 01-2-2V9a2 2 0 012-2h10a2 2 0 012 2z" />
      ...
      <div className="ml-6 grow">
        <p className="mb-2 font-bold text-brown-800">Kampaniyalar və Xəbərlər</p>
