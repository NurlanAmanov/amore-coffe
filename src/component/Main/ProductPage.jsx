...
function ProductPage() {
  ...
  {/* Qiymer */}
            <div class="flex gap-2 items-center border border-gray-300  mt-4 bg-white px-3 py-2 w-max">
          ...
          <div class="mt-4 flex flex-wrap gap-4">
            ...
            <button  onClick={() => {
              ...
              class="px-4 py-3 w-[45%] border border-[#7a461f] outline-none bg-[#7a461f] hover:bg-white hover:text-black duration-300 text-white text-sm font-semibold">
              Səbətə at</button>
          </div>
        </div>
