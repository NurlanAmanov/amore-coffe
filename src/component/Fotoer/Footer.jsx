  ...
  return (
   ...
   <footer className="bg-[#ffb71c]  pt-12 pb-6 px-10 font-sans tracking-wide relative">
      ...
      <div className="flex max-lg:flex-col items-center justify-between gap-x-6 gap-y-8">
        ...
        <li><a href=":void(0)" className="text-black hover:text-white text-md font-semibold">Xidmət Şərtləri</a></li>
<li><a href="/" className="text-black hover:text-white text-md font-semibold">Məxfilik Siyasəti</a></li>
<li><a href="/" className="text-black hover:text-white text-md font-semibold">Əlaqə</a></li>
