...
{sebet && sebet.map((item,i)=>{
    return(
     ...
     {item.quantity}
        ...
        <td class="p-4 text-sm">
          <svg class="w-4 h-4 inline mr-1.5" viewBox="0 0 14 13" fill="#fff" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <div class="md:flex m-4">
        <p class="text-sm text-white flex-1">Showind 1 to 5 of 100 entries</p>
        <div class="flex items-center max-md:mt-4">
          <p class="text-sm text-white">Display</p>

          <select class="text-sm text-white border border-gray-400 rounded h-8 px-1 mx-4 outline-none">
            <option>5</option>
            <option>10</option>
            <option>20</option>
            <option>50</option>
          ...
          <ul class="flex space-x-1 ml-4">
            ...
            <li class="flex items-center justify-center cursor-pointer text-sm bg-[#ffff] text-black w-8 h-8 rounded">
              2
            </li>
            <li class="flex items-center justify-center cursor-pointer text-sm w-8 h-8 rounded">
              3
